...
ggplot(ChCr,aes(x = Julian.Day ,y = Conductivity, colour = Site, group = Site)) + 
  geom_line() +
  theme_classic() +
  xlim(510,1010) +
  labs(y = "Conductivity ms/cm", x = "Julian Day")

ggplot(NrCr,aes(x = Julian.Day ,y = Conductivity, colour = Site)) + 
  geom_line() +
  theme_classic() +
  xlim(510,1010) +
  labs(y = "Conductivity ms/cm", x = "Julian Day")

ggplot(OhRv01,aes(x = Julian.Day ,y = Conductivity, colour = Site, group = Site)) + 
  geom_line() +
  theme_classic() +
  xlim(510,1010) +
  labs(y = "Conductivity ms/cm", x = "Julian Day")

ggplot(WeCr07,aes(x = Julian.Day ,y = Conductivity, colour = Site, group = Site)) + 
  geom_line() +
  theme_classic() +
  xlim(510,1010) +
  labs(y = "Conductivity ms/cm", x = "Julian Day")
