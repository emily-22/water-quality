...
ggplot(WeCr,aes(x = Julian.Day ,y = Chloride, colour = Site, group = Site)) + 
  ...
  labs(y = "Chloride mg/L", x = "Julian Day")
```
#W#eCr Chloride vs Conductivity
```{r}

summary(lm(WeCr$Chloride~ WeCr$Conductivity))
plot(WeCr$Chloride~ WeCr$Conductivity)
abline(lm(WeCr$Chloride~ WeCr$Conductivity))
```

#WdCr Chloride vs Conductivity
```{r}


summary(lm(WdCr$Chloride~ WdCr$Conductivity))
plot(WdCr$Chloride~ WdCr$Conductivity)
abline(lm(WdCr$Chloride~ WdCr$Conductivity))
```
...
##North Fork Chloride vs Conductivity
```{r}

summary(lm(NfSh$Chloride~ NfSh$Conductivity))
plot(NfSh$Chloride~ NfSh$Conductivity)
abline(lm(NfSh$Chloride~ NfSh$Conductivity))
```
...
##Buffalo Creek Chloride vs Conductivity
```{r}

summary(lm(BfCr$Chloride~ BfCr$Conductivity))
plot(BfCr$Chloride~ BfCr$Conductivity)
abline(lm(BfCr$Chloride~ BfCr$Conductivity))
```
## Acid Mine sites
```{r}
